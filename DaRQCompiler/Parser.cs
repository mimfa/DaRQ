...
using MiMFa.DaRQ.Compiler.Parser;

namespace MiMFa.DaRQ.DaRQCompiler
{
    public class Parser : MiMFa.DaRQ.JavaScriptCompiler.Parser
    {
            ...
            switch (token.Value.ToLower())
            {
                ...
                case "as":
                    ...
                    if (alias != null)
                    {
                        ...
                        return CreateNode(aliasValue, NodeType.Compute, TokenType.ObjectData, value);
                    }
                    return CreateNode("", NodeType.Compute, TokenType.ObjectData);
