...
namespace DaRQ.Compiler.Generator
{
    public abstract class Generator : IStage
    {
        ...
        public object Transform(object input, DaRQ.Compiler.Compiler compiler)
        {
            ...
            var walker = new Assembler.NodeWalker(program.Children, compiler?.Input?.Source);
            return Generate(walker, compiler).ToArray();
        }

        public IEnumerable<string> Generate(Assembler.NodeWalker walker, DaRQ.Compiler.Compiler compiler = null)
        {
