...
{
    public class Parser : MiMFa.DaRQ.Compiler.Parser.Parser
    {
        protected Node ParseTokenSingle(TokenWalker walker)
        {
        ...
        protected IEnumerable<Node> ParseTokens(TokenWalker walker)
        {
